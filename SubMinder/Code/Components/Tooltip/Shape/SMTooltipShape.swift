...
struct SMTooltipShape: InsettableShape {

    let axisMode: SMAxisMode
...
struct TooltipShape_Previews: PreviewProvider {
    static var previews: some View {
        VStack {
            SMTooltipShape(axisMode: .leading, cornerRadius: 30, arrowWidth: 20, arrowHeight: 20, arrowPosition: 120)
                .stroke()
                .font(.callout)
                .padding()
                .frame(width: 200)
            Spacer()
            SMTooltipShape(axisMode: .trailing, cornerRadius: 60, arrowWidth: 20, arrowHeight: 20, arrowPosition: 0)
                .stroke()
                .fill(Color.blue)
